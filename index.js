...
text: "*🥷 ASHIYA-MD 🥷 successfully connected* ✓\n\n Use .Update command to see 𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 new update news \n\n> ◦ *Official  Chanel* - ```https://whatsapp.com/channel/0029VbACpjVGJP8Pvuy1nC3T```\n> ◦ ᴊᴏɪɴ ᴏᴜʀ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ᴠɪᴀ ᴛʏᴘᴇ: .joinsup\n*🥷 𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 🥷 ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴄʀᴇᴀᴛᴇᴅ ʙʏ • 𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃*",
contextInfo: {
externalAdReply: {
...
mediaType: 1,
sourceUrl: "https://wa.me/94760746437" ,
thumbnailUrl: 'https://files.catbox.moe/zupeb7.jpg' ,
...
body: config.B_LINE,
mediaType: 1,
sourceUrl: "https://files.catbox.moe/z5s3gw.jpg",
thumbnailUrl: "https://files.catbox.moe/z5s3gw.jpg" ,
renderLargerThumbnail: false
...
app.get("/", (req, res) => {
res.send("📟 𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 Working successfully!");
});
