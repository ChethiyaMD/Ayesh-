...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(
            from,
            {
                text: `*𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 GDRIVE DOWNLOADER*
...
> *𝐏𝐎𝐖𝐄𝐑𝐃 𝘽𝙔 𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 🥷🇱🇰*`,
                contextInfo: {
                    ...
                    isForwarded: true,
                    externalAdReply: {
                        title: `𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 Gdrive Downloader`,
                        body: `${fileInfo.fileName || fileInfo.title || `Undefined`} : Powered By 𝐀𝐒𝐇𝐈𝐘𝐀-𝐌𝐃 Gdrive Engine`,
        ...
        if (fileSizeBytes > 𝐀𝐒𝐇𝐈𝐘𝐀_DOWNLOAD_SIZE) {
